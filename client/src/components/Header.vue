    ...
    <nav class="navbar navbar-expand-lg primary-header">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav" style="margin-left: 5.5rem; ">
            <!-- <router-link tag="li" exact to="/Dashboard" active-class="active" class="nav-item">
              <span class="nav-link pl-4 pr-4">Home</span>
            </router-link>-->
            <!-- <router-link tag="li" exact to="/Dashboard" class="nav-item">
              <span class="nav-link pl-4 pr-4">Dashboard</span>
            </router-link>-->
            <li class="nav-item search-parent" v-if="isAuthenticated">
              ...
              <div
                :class="handles && search || error && search ?'search-dropdown' : 'search--hide'"
              >
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item menu-notify" v-if="isAuthenticated">
              <svg
                width="23"
            ...
            <li class="nav-item ml-4 mr-3 menu-parent" v-if="isAuthenticated">
              <div
                v-if="authUser.image"

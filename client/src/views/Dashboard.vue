            ...
            <div class="p-3 suggestion">
              ...
              <div class="d-flex flex-row align-items-center mb-3">
                ...
                <div class="d-flex flex-column">
                  ...
                  <div class="text-sec1">@victor</div>
                </div>
              </div>
              <div class="d-flex flex-row align-items-center mb-3">
                <svg
              ...
              <div class="d-flex flex-row align-items-center mb-3">
                ...
                <div class="d-flex flex-column">
                  ...
                  <div class="text-sec1">@m_Slim</div>
                </div>
              </div>
            </div>
          </div>
